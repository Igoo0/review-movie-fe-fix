...
const EditMovie = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Append poster file if a new one is selected
      if (posterFile) {
        submitData.append('poster', posterFile);
      }
      
      await axios.patch(`https://buku-tukar-559917148272.us-central1.run.app/Movies/${id}`, submitData, {
        headers: {
  ...
  return (
    <div style={{
      ...
      <div className="form-container">
        <h1 className="title-main">Edit Movie</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="field-group">
            ...
            {currentPoster && !posterPreview && (
              <div className="current-poster-section">
                <p style={{ color: '#64ffda', fontWeight: '600', marginBottom: '0.5rem' }}>
                  Current Poster:
                </p>
                <img 
                  src={currentPoster} 
              ...
              {!posterPreview ? (
                <div>
                  <div className="upload-text">
                    {currentPoster ? 'Click to upload new poster' : 'Click to upload poster'}
                  </div>
            ...
            <p className="help-text">
              {posterFile ? (
                <span style={{ color: '#64ffda' }}>New poster selected: {posterFile.name}</span>
              ) : currentPoster ? (
                'No new poster selected - current poster will be kept'
              ) : (
                'No poster selected'
              )}
            </p>
